...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with open(file_name) as f:
            reader = csv.DictReader(f, dialect=csv.excel_tab, fieldnames=['imdb_id', 'name', 'birth_date', 'death_date', 'primary_profession', 'known_for'])
            ...
            for line in reader:
                ...
                person, created = Person.objects.get_or_create(imdb_id=imdb_id,
